                    ...
                    if rec.rate_amtc == 0:
                        if rec.rate_amtc < rec.price_subtotal:
                            # if rec.rate_amtc == 0:
                                ...
                                tax_amount = rate_amount + (rate_amount * rec.invoice_line_tax_id4/100)
                                ...
                                rec.amt_w_tax = tax_amount
                                rec.product_tax = rec.amt_w_tax - rec.price_subtotal
                                rec.amount_residual = tax_amount
                                rec.amount_residual_currency = tax_amount
